    ...
    <div class="slideall">
        ...
        <div id="nav" class="navfull">
            <div class="area clearfix">
                <div class="category-content" id="guide_2">
                    <div class="category">
                        <c:forEach items="${fatherList}" var="f">
                            <ul class="category-list" id="js_climit_li">
                                <li class="appliance js_toggle relative first">
                                    <div class="category-info myFatherCate">
                                        <h3 class="category-name b-category-name">
                                            <i><img src="static/images/cake.png"></i>
                                            <input class="myFatherCateId" hidden="hidden" value="${f.father_id}" />
                                            <a class="ml-22 "  title="${f.father_name}">${f.father_name}</a>
                                        </h3>
                                        <em>&gt;</em>
                                    </div>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                $('.myFatherCate').on("mousemove",function () {

                    var id=$(this).children().find(".myFatherCateId").val();
                    $.ajax({
                        URL:"/home",
                        type:"post",
                        data:{father_id:id},
                        ...
                        success:function (data) {
                            var html="";
                            $.each(data,function (index,childs) {
                                html+="<dd>";
                                html+="<a href='/products?child_id="+childs.child_id+"'><span>"+childs.child_name+"</span></a>";
                                html+="</dd>";
                            })
                            $('.myChildCate').html(html);
                        }
                    })
                })
    ...
    <c:forEach items="${fatherList}" var="f">
        <div id="f1">
            <div class="am-container ">
                <div class="shopTitle myFatherCate2">
                    <input class="myFatherCateId2" hidden="hidden" value="${f.father_id}" />
                    <h4>${f.father_name}</h4>
                    <span class="more ">
        ...
        <script type="text/javascript">
            $(function() {
                ...
                function getAll() {
                    ...
                    var id=$('.myFatherCate2').find("input").val();
                    $.ajax({
                        URL:"/home",
                        type:"post",
                        data:{father_id:id},
                        ...
                        success:function (data) {
                            var html="";
                            $.each(data,function (index,childs) {
                               html+="<a class='outer' href='#'><span class='inner'>";
                               html+="<b class='text'>"+childs.child_name+"</b>";
                               html+="</span></a>";
                            })
                            console.log(html);
                            $('.myChildCate2').html(html);
                        }
                    })
                }
            });
