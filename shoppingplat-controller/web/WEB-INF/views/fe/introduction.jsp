        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    <a href="${photo.get(0).img_path}"><img src="${photo.get(0).img_path}" alt="细节展示放大镜特效" rel="${photo.get(0).img_path}" class="jqzoom" /></a>
                </div>
                <ul class="tb-thumb" id="thumblist">
                    <c:forEach items="${photo}" var="p" begin="0" end="4">
                        <li class="tb-selected">
                            <div class="tb-pic tb-s40">
                                <a href="${p.img_path}"><img src="${p.img_path}" mid="${p.img_path}" big="${p.img_path}"></a>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price">${proInfos.compute}</b>  </dd>
                    </li>
                    <li class="price iteminfo_mktprice">
                        <dt>原价</dt>
                        <dd><em>¥</em><b class="sys_item_mktprice">${proInfos.pro_iPrice}</b></dd>
                    </li>
                    <div class="clear"></div>
                </div>
                ...
                <ul class="tm-ind-panel">
                    ...
                    <li class="tm-ind-item tm-ind-sumCount canClick">
                        <div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">${proInfos.pro_allSaleNum}</span></div>
                    </li>
                ...
                <dl class="iteminfo_parameter sys_item_specpara">
                    ...
                    <dd>
                        ...
                        <span id="Stock" class="tb-hidden">库存<span class="stock">${proInfos.pro_num}</span>件</span>
                    </dd>
...
<div class="shopPromotion gold">
    <div class="hot">
        ...
        <div class="gold-list">
            <p>${proInfos.pro_Desc}<span>查看优惠券<i class="am-icon-sort-down"></i></span></p>
        </div>
    </div>
    <div class="clear"></div>
    <div class="coupon">
...
<div class="pay">
    ...
    <li>
        <div class="clearfix tb-btn tb-btn-buy theme-login fastBuy">
            <a id="LikBuy" title="点此按钮到下一步确认购买信息" >立即购买</a>
        </div>
    </li>
    <li>
        <div class="clearfix tb-btn tb-btn-basket theme-login joinCart"  >
        ...
        <div class="mc">
            <ul>
                ...
                <c:forEach items="${productVO.set}" var="vo" >
                    <li class="first">
                        <div class="p-img">
                            <a  href="#"> <img src="${photo.get(0).img_path}"> </a>
                        </div>
                        <div class="p-name"><a href="#">${vo.pro_name}</a></div>
                        <div class="p-price"><strong>${vo.compute}</strong></div>
                    </li>
                </c:forEach>
            </ul>
        </div>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active">
                    <div class="J_Brand">
                        ...
                        <div class="clear"></div>
                        <ul id="J_AttrUL">
                            <li title="">生产许可证编号：&nbsp;${proInfos.information.info_code}</li>
                            <li title="">产名:&nbsp;${proInfos.information.factory_name}</li>
                            <li title="">产址:&nbsp;${proInfos.information.factory_address}</li>
                            <li title="">产家联系方式:&nbsp;${proInfos.information.factory_phone}</li>
                            <li title="">保质期:&nbsp;${proInfos.information.keep_time}</li>
                            <li title="">生产日期&nbsp;${proInfos.information.product_time}</li>
                            <li title="">配送:&nbsp;${proInfos.information.delivery_address}</li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <c:forEach items="${photo}" var="photo" begin="6" end="${length+1}">
